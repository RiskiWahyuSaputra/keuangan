        ...
        return (
          <li key={item.category} className="px-6 py-3.5">
            <div className="flex items-baseline justify-between gap-4">
              <p className="flex min-w-0 items-center gap-2.5 text-sm font-medium text-slate-900">
                <span className="grid h-6 w-6 shrink-0 place-items-center rounded-xl bg-white/70 border border-white/80 shadow-xs text-xs font-semibold text-slate-600 tabular-nums">
                  {index + 1}
                </span>
            ...
            <div className="mt-2 flex items-center gap-3">
              <div
                className="h-2 flex-1 overflow-hidden rounded-full bg-slate-200/50 p-0.5"
                role="presentation"
              >
                <div
